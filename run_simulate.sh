...
#tmux new-session -d  "Rscript simulate_large.R path simulations/ p 100 N 1000 P 100 "
#tmux new-session -d  "Rscript simulate_large.R path simulations/ p 200 N 1000 P 200 "
#tmux new-session -d  "Rscript simulate_large.R path simulations/ p 500 N 1000 P 500 "
