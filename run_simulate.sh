...
#tmux new-session -d  "Rscript simulate_ou.R path simulations/ p 90 N 1000 P 90 "
#tmux new-session -d  "Rscript simulate_ou.R path simulations/ p 100 N 1000 P 100 "
